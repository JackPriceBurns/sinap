...
@section('content')
    ...
    <div class="container">
        ...
        <div class="col-md-8">
            <button type="button" class="btn btn-default" data-toggle="modal" data-target="#addClass">Add Class</button>
            <hr />
            ...
            <table id="searchableTable" class="table table-bordered" style="margin:0;">
                ...
                @foreach ($classrooms as $classroom)
                    <tr>
                        ...
                        <td><a href="/manage/classes?add={{ $classroom->id }}">Add Students</a> <a href="/manage/classes/delete.{{ $classroom->id }}">Delete</a></td>
                    </tr>
                @endforeach
                </tbody>
            </table>
